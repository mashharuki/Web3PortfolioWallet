...
export class balanceChanged extends ethereum.Event {
  get params(): balanceChanged__Params {
    return new balanceChanged__Params(this);
  }
}

export class balanceChanged__Params {
  _event: balanceChanged;

  constructor(event: balanceChanged) {
    this._event = event;
  }
...
export class MyToken__checkpointsResultValue0Struct extends ethereum.Tuple {
...
export class MyToken extends ethereum.SmartContract {
  ...
  checkpoints(
    account: Address,
    pos: BigInt
  ): MyToken__checkpointsResultValue0Struct {
    let result = super.call(
      "checkpoints",
    ...
    return changetype<MyToken__checkpointsResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_checkpoints(
    account: Address,
    pos: BigInt
  ): ethereum.CallResult<MyToken__checkpointsResultValue0Struct> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):((uint32,uint224))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<MyToken__checkpointsResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  try_getScore(addr: Address): ethereum.CallResult<BigInt> {
  ...
  scores(param0: Address): BigInt {
    let result = super.call("scores", "scores(address):(uint256)", [
  ...
  try_scores(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall("scores", "scores(address):(uint256)", [
      ethereum.Value.fromAddress(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
