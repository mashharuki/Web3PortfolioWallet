import {
  ...
  UpdateScore as UpdateScoreEvent,
  balanceChanged as balanceChangedEvent
...
export function handleUpdateScore(event: UpdateScoreEvent): void {
  let entity = new UpdateScore(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.to = event.params.to
...
export function handlebalanceChanged(event: balanceChangedEvent): void {
  let entity = new balanceChanged(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.to = event.params.to
  entity.amount = event.params.amount
  entity.balanceOf = event.params.balanceOf
